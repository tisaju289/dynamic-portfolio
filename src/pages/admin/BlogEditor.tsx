        ...
        <div className="overflow-x-auto">
          <Table>
            ...
            <TableBody>
              ...
              {posts.length === 0 && (
                <TableRow><TableCell colSpan={4} className="text-center text-muted-foreground py-8">No blog posts yet</TableCell></TableRow>
              )}
            </TableBody>
          </Table>
        </div>
          ...
          <ScrollArea className="max-h-[90vh]">
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea value={editing?.content_bn || ""} onChange={(e) => setEditing({ ...editing, content_bn: e.target.value })} rows={4} className="w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
              </div>
              <div>
                <label className="block text-xs font-medium mb-1">Content (English)</label>
                <textarea value={editing?.content_en || ""} onChange={(e) => setEditing({ ...editing, content_en: e.target.value })} rows={4} className="w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
              </div>
