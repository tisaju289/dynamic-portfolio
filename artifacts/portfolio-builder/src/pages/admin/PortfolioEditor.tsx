        ...
        <DialogContent className="max-w-2xl max-h-[90vh] p-0 overflow-hidden">
          <ScrollArea className="max-h-[90vh]">
            <div className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="flex items-center gap-2 text-xs font-medium mb-1">Description (Bengali) <TranslateButton sourceText={editing?.description_en || ""} targetLang="bn" onTranslated={(t) => setEditing({ ...editing, description_bn: t })} /></label>
                ...
                <div>
                  <label className="flex items-center gap-2 text-xs font-medium mb-1">Description (English) <TranslateButton sourceText={editing?.description_bn || ""} targetLang="en" onTranslated={(t) => setEditing({ ...editing, description_en: t })} /></label>
